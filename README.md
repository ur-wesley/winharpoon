...
This produces `dist\WinHarpoon-Setup-1.0.0.exe`. The installer offers a **Start WinHarpoon when Windows starts** option during setup. You can change this anytime in tray → **Settings** → **General**.
